...
var siteURL = 'http://prov.local/'

/*===================
	AUTHOR`S SCRIPTS
=====================*/ 
function changePagination(obj) {
	var newChange = obj.value;
	document.location.href = siteURL + 'shop.php?ch_val=' + newChange;
}

function changePaginationCat (obj, cat_id) {
	document.location.href = siteURL + 'shop-category.php?ch_val=' + obj.value +'&category_id=' + cat_id;
}
