var siteURLAdmin = "http://laraveltest.local/admin";

function deleteBook(id) {
	// Аякс запрос на добавление товара в корзину
	var ajax = new XMLHttpRequest();
		ajax.open("POST", siteURLAdmin + "/modules/products/delete_products.php", false);
		// тип передаваемых данных закодирован
